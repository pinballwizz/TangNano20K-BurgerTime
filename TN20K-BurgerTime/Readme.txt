Burger Time Arcade for the Tang Nano 20K FPGA Dev Board. Pinballwiz.org 2025
Code by DarFPGA.
...
Build:
* Obtain correct roms file for Burger Time (see scripts in tools folder for rom details).
* Unzip rom files to the tools folder.
* Run the make burger time proms script in the tools folder.
